...
// loadValidSlugs + findSkuCollision moved to
// src/lib/admin/product-validation.ts so the Excel bulk-import reuses the
// EXACT same taxonomy + SKU-uniqueness rules (imported at the top).
